...
_PRESET_CONFIGS: list[dict] = [
    # ── Multi-Perspective ───────────────────────────────────────────
    {
        ...
        "primary_id": "minimax-m2.7",
        "routing": {
            "prompt_enhancement": "minimax-m2.5",
            "classification": "minimax-m2.5",
            "decomposition": "minimax-m2.7",
            "constructive": "minimax-m2.7",
            "destructive": "mistral-large-3",
            "systemic": "minimax-m2.7",
            "minimalist": "minimax-m2.5",
            "scoring": "minimax-m2.7",
            "stress_testing": "minimax-m2.7",
            "synthesis": "qwen3-max"
        },
        "fallback_routing": {
        ...
        "notes": [
            ...
            "MiniMax models provide speed and efficiency in early phases and strong reasoning in complex phases."
        ],
    },
    {
        ...
        "notes": [
            ...
            "MiMo V2 Pro for high-quality synthesis.",
    ...
    },
    {
        ...
        "routing": {
            ...
            "classification": "mimo-v2-flash",
            "decomposition": "mimo-v2-pro",
            "constructive": "mimo-v2-pro",
            "destructive": "kimi-k2-6",
            "systemic": "mimo-v2-pro",
            "minimalist": "gemini-flash",
            "scoring": "sonar-pro",
            "stress_testing": "mimo-v2-pro",
            "synthesis": "mimo-v2-pro"
        },
        "fallback_routing": {
            "prompt_enhancement": "claude-sonnet",
        ...
        "notes": [
            "MiMo V2 Pro as primary model for strong reasoning in complex phases.",
            "MiMo V2 Flash for efficient early-phase prompt enhancement and classification.",
    ...
    # ── Delphi ───────────────────────────────────────────────────────
    {
        ...
        "routing": {
            ...
            "stress_testing": "minimax-m2.7",
            "synthesis": "qwen3-max",
            "expert_1": "minimax-m2.7",
            "expert_2": "qwen3-max",
            "expert_3": "glm-4-air",
            "expert_4": "minimax-m2.5",
        },
        "fallback_routing": {
            "prompt_enhancement": "glm-4-air",
            "classification": "glm-4-air",
        ...
        "notes": [
            ...
            "MiniMax models provide speed and efficiency in early phases and strong reasoning in complex phases, including expert roles."
        ],
    },
    {
        "id": "delphi-premium",
    ...
    # ── CoVe ─────────────────────────────────────────────────────────
    {
        ...
        "routing": {
            ...
            "classification": "minimax-m2.5",
            "decomposition": "minimax-m2.7",
            "cove_draft": "minimax-m2.7",
            "cove_verify": "qwen3-max",
            "cove_answer": "glm-4-air",
            "cove_revise": "minimax-m2.5",
            "scoring": "glm-4-air",
            "stress_testing": "minimax-m2.7",
            "synthesis": "qwen3-max"
        },
    ...
    # ── ToT ──────────────────────────────────────────────────────────
    {
        ...
        "routing": {
            ...
            "classification": "minimax-m2.5",
            "decomposition": "minimax-m2.7",
            "tot_decompose": "minimax-m2.7",
            "tot_generate": "qwen3-max",
            "tot_evaluate": "glm-4-air",
            "tot_backtrack": "minimax-m2.5",
            "scoring": "glm-4-air",
            "stress_testing": "minimax-m2.7",
            "synthesis": "qwen3-max"
        },
    ...
    # They route each subagent to a specific model with cross-lab fallbacks.
    {
        ...
        "routing": {
            ...
            "stress_testing": "minimax-m2.7",
            "synthesis": "qwen3-max",
            "subagent_synthesis_analysis": "minimax-m2.7",
            "subagent_synthesis_writer": "qwen3-max",
            "subagent_critique_logic": "glm-4-air",
            "subagent_critique_evidence": "minimax-m2.5",
            "subagent_critique_bias": "minimax-m2.7",
            "subagent_critique_counter": "qwen3-max",
            "subagent_enhancement": "minimax-m2.5",
            "subagent_decomposition": "minimax-m2.7",
        ...
        "notes": [
            ...
            "MiniMax models provide speed and efficiency in early phases and strong reasoning in complex subagent roles."
        ],
    },
    {
        "id": "subagent-premium",
    ...
    # ── Writing (Research-Backed Article) ────────────────────────────
    {
        ...
        "primary_id": "minimax-m2.7",
        "routing": {
            "article_decompose": "minimax-m2.7",
            "article_claim_extract": "mistral-large-3",
            "article_cove_verify": "deepseek-r1t2-chimera",
            "article_cove_answer": "minimax-m2.7",
            "article_cove_revise": "minimax-m2.7",
            "article_verifier": "minimax-m2.7",
            "article_sot_skeleton": "minimax-m2.7",
            "article_sot_solve": "kimi-k2-6",
            "article_synthesize": "kimi-k2-6",
            "article_pre_mortem": "minimax-m2.7",
            "article_critic": "minimax-m2.7",
        ...
        "notes": [
            ...
            "MiniMax models provide strong reasoning and efficiency in article generation phases."
        ],
    },
    {
        "id": "writing-premium",
        ...
        "routing": {
            ...
            "article_pre_mortem": "mimo-v2-pro",
            "article_critic": "mimo-v2-pro",
