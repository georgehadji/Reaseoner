    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: '-20%',
          right: '-15%',
          background: 'radial-gradient(circle, rgba(59,130,246,0.20) 0%, rgba(59,130,246,0.06) 45%, transparent 70%)',
          filter: 'blur(80px)',
      ...
      <div
        ...
        style={{
          ...
          bottom: '-15%',
          left: '-20%',
          background: 'radial-gradient(circle, rgba(6,182,212,0.14) 0%, rgba(6,182,212,0.04) 45%, transparent 70%)',
          filter: 'blur(100px)',
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            top: '-10%',
            right: '-5%',
            background: 'radial-gradient(circle, rgba(59,130,246,0.35) 0%, rgba(59,130,246,0.12) 40%, transparent 65%)',
            filter: 'blur(70px)',
        ...
        <div
          ...
          style={{
            ...
            bottom: '-10%',
            left: '-10%',
            background: 'radial-gradient(circle, rgba(6,182,212,0.25) 0%, rgba(6,182,212,0.08) 40%, transparent 65%)',
            filter: 'blur(80px)',
      ...
      <div
        ...
        style={{
          ...
          boxShadow: active ? '0 0 40px 2px rgba(59,130,246,0.25)' : 'none',
