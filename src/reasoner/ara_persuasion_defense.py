"""
ARA Persuasion Defense Module
=============================
Production module for a hallucination mitigation pipeline ("ARA") targeting
...
class TacticDetectionStage(PersuasionDefenseStage):
    """
    Two-tier persuasion detection following ARA's NLI-before-LLM cost ordering.
...
class ARAPersuasionIntegration:
    """
    Integration adapter between the PersuasionDefensePipeline and the
    existing ARA hallucination mitigation pipeline.
    """
    ...
    async def process(
        ...
        """Main integration entry point. Called by ARA's orchestrator."""
    ...
    def inject_taints(
        ...
        """Merge persuasion taints into ARA's existing taint chain."""
    ...
    def adjust_confidence(
        ...
        """
        Apply persuasion risk penalty to ARA's confidence score.
