...
ANALOGICAL_ABSTRACTION_SYSTEM = (
    ...
    "Focus on constraints, objectives, actors, and dynamics — not surface features. "
...
ANALOGICAL_DOMAIN_SEARCH_SYSTEM = (
    ...
    "Given an abstract problem structure, identify domains where an isomorphic problem has already been solved. "
    "Output ONLY valid JSON."
)
...
ANALOGICAL_MAPPING_SYSTEM = (
    ...
    "Identify object-attribute mappings, relational mappings, and higher-order relational mappings. "
    "Output ONLY valid JSON."
)
...
ANALOGICAL_TRANSFER_SYSTEM = (
    ...
    "Be explicit about what transfers cleanly, what must be adapted, and where the analogy breaks. "
    "Output ONLY valid JSON."
)
...
DELPHI_EXPERT_SYSTEM = (
    ...
    "Be specific and provide a numeric estimate where possible. "
    "Output ONLY valid JSON."
)
...
DELPHI_REVISION_SYSTEM = (
    ...
    "You may revise toward consensus or defend your original position with reasoning. "
    "Output ONLY valid JSON."
)
...
DELPHI_CONVERGENCE_SYSTEM = (
    "You are a Delphi facilitator checking if expert estimates have converged to consensus. "
    "Output ONLY valid JSON."
)
