...
_PRESET_CONFIGS: list[dict] = [
    ...
    },
    {
        "id": "debate-premium",
        "name": "Debate (Premium)",
        "description": "Elite debate. Claude Sonnet vs Kimi K2.5, judged by Perplexity Sonar Pro. 3 different training paradigms + live fact-checking.",
        ...
        "notes": [
            ...
            "Kimi K2.5: 1M+ context, strongest creative reasoning in Chinese OSS",
    ...
    },
    {
        ...
        "description": "Elite 6-model jury with live fact-checking. Claude + Kimi + DeepSeek + Gemini + Perplexity + GLM. Cross-ecosystem for maximum coverage.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
    ...
    },
    {
        ...
        "description": "Elite scientific reasoning. Claude for hypothesis generation, Kimi for testing, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for testing: 1M+ context, strong evaluation",
    ...
    },
    {
        ...
        "description": "Elite Socratic dialogue. Claude for questions, Kimi for answers, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for answers: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── Pre-Mortem ───────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite pre-mortem analysis. Claude for failure scenarios, Kimi for backtracking, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for backtracking: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── Bayesian ─────────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite Bayesian reasoning. Claude for priors, Kimi for likelihood, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for likelihood: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── Dialectical ──────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite dialectical reasoning. Claude for thesis, Kimi for antithesis, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for antithesis: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── Analogical ───────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite analogical reasoning. Claude for abstraction, Kimi for domain search, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for domain search: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── Delphi ───────────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite Delphi consensus. 4 top models (Claude, Kimi, DeepSeek, Gemini) with Perplexity Sonar Pro for fact-checking.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            "Claude + Kimi + DeepSeek + Gemini: 4 top ecosystems",
    ...
    },
    {
        ...
        "description": "Elite CoVe. Claude for drafting, Kimi for verification, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for verification: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── SoT ──────────────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite SoT. Claude for skeleton, Kimi for solving, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for solving: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── ToT ──────────────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite ToT. Claude for decomposition, Kimi for generation, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for generation: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── PoT ──────────────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite PoT. Claude for generation, Kimi for execution, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for execution: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
    # ── Self-Discover ────────────────────────────────────────────────
    ...
    },
    {
        ...
        "description": "Elite self-discovery. Claude for selection, Kimi for adaptation, Perplexity for evidence evaluation.",
        "primary_id": "claude-sonnet",
        "routing": {
            "prompt_enhancement": "gemini-flash",
            "classification": "gemini-flash",
        ...
        "notes": [
            ...
            "Kimi for adaptation: 1M+ context, strong reasoning",
            "Perplexity Sonar Pro for evidence evaluation: live web fact-checking",
        ],
    },
